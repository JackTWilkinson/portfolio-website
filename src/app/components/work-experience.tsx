...
const WorkExperienceItem: React.FC<WorkExperienceProps> = (props: WorkExperienceProps) => {
  //TODO mobile support
    return (
      <div tabIndex={0} className='font-roboto text-inherit collapse -lg:collapse-open sm:w-3/4 border-8 bg-black border-blue-950 text-primary-content focus:text-secondary-content:text-inherit rounded-box'>
