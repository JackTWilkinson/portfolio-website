...
const WorkExperienceItem: React.FC<WorkExperienceProps> = (props: WorkExperienceProps) => {
    return (
        <>
            <div tabIndex={0} className='w-3/4 text-inherit collapse border-8 bg-black border-blue-950 text-primary-content focus:text-secondary-content:text-inherit rounded-box'>
